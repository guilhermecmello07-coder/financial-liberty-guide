...
const menuItems = [
  ...
  { icon: Target, label: "Plano de Ataque", id: "estrategia" },
  { icon: TrendingUp, label: "Progresso", id: "progresso" },
  { icon: Calculator, label: "Calculadora", id: "calculadora" },
  { icon: Shield, label: "Seus Direitos", id: "direitos" },
  { icon: Rocket, label: "Renda Extra", id: "renda" },
  { icon: BookOpen, label: "Educação", id: "educacao" },
];
  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="mx-3 mb-4 p-2 rounded-lg text-primary-foreground/60 hover:text-primary-foreground hover:bg-sidebar-accent/50 transition-colors flex items-center justify-center"
      >
